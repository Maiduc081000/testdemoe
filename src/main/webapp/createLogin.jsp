<%-- 
    ...
    Created on : 06-08-2022, 10:41:01
    Author     : MND PC
--%>
        ...
        <jsp:include page="Include/taskbar.jsp"></jsp:include>
            ...
            <div class="row">
                <div class="span12">
                    ...
                    <div class="row">
                        <div style="margin-left: 300px" class="span5">
                            <div class="well">
                                <h5>Tạo tài khoản</h5>
                                <form action="createLogin" method="post">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span4" name="user" type="text" placeholder="nhập tài khoản">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="inputPassword">Nhập lại mật khẩu</label>
                                        <div class="controls">
                                            <input type="password" name="repass" class="span4" placeholder="Repeat Password">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="inputPassword">Tên khách hàng</label>
                                        <div class="controls">
                                            <input type="text" name="name" class="span4" placeholder="Nhập tên">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="inputPassword">Số điện thoại</label>
                                        <div class="controls">
                                            <input type="text" name="phone" class="span4" placeholder="Nhập số điện thọai">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="inputPassword">Địa chỉ</label>
                                        <div class="controls">
                                            <input type="text" name="address" class="span4" placeholder="Nhập địa chỉ">
                                        </div>
                                    </div>
                                    
                                    <div class="controls">
                                        <button style="color: #0088cc" type="submit" class="btn block">Tạo tài khoản</button>
                                    </div>
                                </form>
                                <button  class="btn block"><a href="login.jsp">Đăng nhập</a></button>
                            </div>
                        </div>
                        <div class="span1"> &nbsp;</div>
                    </div>
